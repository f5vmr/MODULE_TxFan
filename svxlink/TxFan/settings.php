...
<!-- BEGIN FORM CONTENTS -->
	...
	<fieldset>
		<legend>UHF PA Heatsink Fan Module Settings</legend>
		  <div class="control-group">
			<label class="control-label" for="mode">Fan Timer Configuration</label>
			<div class="controls">
			  <select id="mode" name="mode">
				  <option value="FOLLOW_PTT">No Longer Available</option>
		  ...
		  <div class="control-group countDownOptions">
			<label class="control-label" for="delay">UHF Fan Run Time</label>
			<div class="controls">
			  <input class="input-xlarge" id="delay" type="number" name="delay" value="<?php echo $moduleSettings['delay']; ?>">
			</div>
		    <span class="help-inline">Fan run time in seconds until fan turns off after PTT drops.</span>
		  </div>

		  <div class="control-group countDownOptions">
			<label class="control-label" for="heatsinkSetpoint">Fan On Temperature</label>
			<div class="controls">
			  <input class="input-xlarge" id="heatsinkSetpoint" type="number" name="heatsinkSetpoint" value="<?php echo $moduleSettings['heatsinkSetpoint']; ?>">
			</div>
		    <span class="help-inline">Temperature at which the fan turns on.</span>
		  </div>

		  <div class="control-group countDownOptions">
			<label class="control-label" for="heatsinkCriticalSetpoint">Repeater Disable Temperature</label>
			<div class="controls">
			  <input class="input-xlarge" id="heatsinkCriticalSetpoint" type="number" name="heatsinkCriticalSetpoint" value="<?php echo $moduleSettings['heatsinkCriticalSetpoint']; ?>">
			</div>
		    <span class="help-inline">Temperature at which Repeater is Disabled.</span>
		  </div>

		  <div class="control-group countDownOptions">
			<label class="control-label" for="offlineCommand">Repeater Disable PIN</label>
			<div class="controls">
			  <input class="input-xlarge" id="offlineCommand" type="number" name="offlineCommand" value="<?php echo $moduleSettings['offlineCommand']; ?>">
			</div>
		    <span class="help-inline">PIN that Disables Repeater due to Over Temperature condition, must match "DTMF Remote Disable" PIN in "General Settings".</span>
		  </div>
